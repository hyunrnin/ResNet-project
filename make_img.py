...
# ROI 평균 비교 기반 false 필터링 활성화
USE_FALSE_DIFF_FILTER = True
FALSE_DIFF_THRESH = 25.0  # true/unknown 평균과 비슷하면 저장 안 함 (값 높을수록 더 엄격)
...
for json_path in json_files:
    ...
    for roi_idx, roi in enumerate(rois):
        ...
        prev_label = None
        saved_count = 0
        label_count = {"false": 0, "true": 0, "unknown": 0}  # 저장된 개수
        label_total = {"false": 0, "true": 0, "unknown": 0}  # 원래 전체 개수
        recent_hashes = []
        ...
        while True:
            ...
            # 4. false ROI가 true/unknown과 너무 비슷하면 저장 안 함
...
# ===== 사용자 설정 =====
JSON_FOLDER = r"C:\Users\user\Desktop\simulation\simulation"
OUTPUT_BASE = r"C:\Users\user\Desktop\simulation\simulation\output"
